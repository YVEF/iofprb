...
static inline void SetupVulkan(ImVector<const char*> instance_extensions)
{
    VkResult err;
...
static inline void SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height)
{
    wd->Surface = surface;
...
static inline void CleanupVulkanWindow()
{
    ImGui_ImplVulkanH_DestroyWindow(g_Instance, g_Device, &g_MainWindowData, g_Allocator);
}

static inline void FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
{
    VkResult err;
...
static inline void FramePresent(ImGui_ImplVulkanH_Window* wd)
{
